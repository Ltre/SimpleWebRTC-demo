    ...
    return function(e, t, n) {
        ...
        1 : [function(e, t) {
            function n(e) {
                ...
                this.capabilities = r,
                i.call(this),
                n = this.connection = c.connect(this.config.url),
                n.on("connect",
                function() {
                    u.emit("connectionReady", n.socket.sessionid),
                    u.sessionReady = !0,
                    u.testReadiness()
                }),
                n.on("message",
                ...
                e.debug = !1,
                this.webrtc = new o(e),
                ["mute", "unmute", "pauseVideo", "resumeVideo", "pause", "resume", "sendToAll", "sendDirectlyToAll"].forEach(function(e) {
                ...
                n.on("stunservers",
                function(e) {
                    u.webrtc.config.peerConnectionConfig.iceServers = e,
                    u.emit("stunservers", e)
                }),
                n.on("turnservers",
                function(e) {
                    u.webrtc.config.peerConnectionConfig.iceServers = u.webrtc.config.peerConnectionConfig.iceServers.concat(e),
            ...
            n.prototype.handlePeerStreamAdded = function(e) {
                ...
                o = s(e.stream);
                e.videoEl = o,
                o.id = this.getDomId(e),
                n && n.appendChild(o),
                this.emit("videoAdded", o, e),
            ...
            function() {
                ...
                function(e, t) {
                    ...
                    n.encodePacket = function(e) {
                        ...
                        case "error":
                            ...
                            h = e.advice ? a(r, e.advice) : ""; ("" !== l || "" !== h) && (p = l + ("" !== h ? "+" + h: ""));
                            break;
                        case "message":
                            "" !== e.data && (p = e.data);
                            break;
                ...
                function(e, t) {
                        ...
                        if (e > 0) for (var t = 0; e > t; t++) {
                            ...
                            if (J.pv[0] > 0) {
                                ...
                                if (r) if (!v($[t].swfVersion) || J.wk && J.wk < 312) if ($[t].expressInstall && a()) {
                                    ...
                                    for (var l = {},
                                    h = r.getElementsByTagName("param"), f = h.length, d = 0; f > d; d++)"movie" != h[d].getAttribute("name").toLowerCase() && (l[h[d].getAttribute("name")] = h[d].getAttribute("value"));
                                    c(p, l, n, o)
                                } else u(r),
                                o && o(i);
                                else w(n, !0),
                    ...
                    function p(e) {
                        ...
                        if (J.win && J.ie) t.innerHTML = e.innerHTML;
                            ...
                            if (n) {
                                ...
                                r = 0; i > r; r++) 1 == o[r].nodeType && "PARAM" == o[r].nodeName || 8 == o[r].nodeType || t.appendChild(o[r].cloneNode(!0))
                            }
                        }
                        return t
                    }
                        ...
                        if (!J.ie || !J.mac) {
                            ...
                            if (i) {
                                ...
                                if (o && (E = null, _ = null), !E || _ != r) {
                                    ...
                                    E = i.appendChild(s),
                                    J.ie && J.win && typeof L.styleSheets != O && L.styleSheets.length > 0 && (E = L.styleSheets[L.styleSheets.length - 1]),
                                    _ = r
                                }
                    ...
                    J = function() {
                        ...
                        !c || typeof M.mimeTypes != O && M.mimeTypes[R] && !M.mimeTypes[R].enabledPlugin || (W = !0, s = !1, c = c.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), a[0] = parseInt(c.replace(/^(.*)\..*$/, "$1"), 10), a[1] = parseInt(c.replace(/^.*\.(.*)\s.*$/, "$1"), 10), a[2] = /[a-zA-Z]/.test(c) ? parseInt(c.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
                    ...
                    return function() {
                        J.w3 && ((typeof L.readyState != O && "complete" == L.readyState || typeof L.readyState == O && (L.getElementsByTagName("body")[0] || L.body)) && e(), X || (typeof L.addEventListener != O && L.addEventListener("DOMContentLoaded", e, !1), J.ie && J.win && (L.attachEvent(I,
                        function() {
                    ...
                    function() {
                        J.ie && J.win && window.attachEvent("onunload",
                        function() {
                            for (var e = B.length,
                    ...
                    } (),
                    {
                        ...
                        expressInstallCallback: function() {
                            if (H) {
                                var e = m(N);
                                e && S && (e.parentNode.replaceChild(S, e), T && (w(T, !0), J.ie && J.win && (S.style.display = "block")), C && C(x)),
                                H = !1
                            }
                        }
                    }
                ...
                function p(e, c) {
                    ...
                    var w = d.map(function(t) {
                        ...
                        if (e.__lookupGetter__ && (e.__lookupGetter__(t) ? i = e.__lookupSetter__(t) ? h("[Getter/Setter]", "special") : h("[Getter]", "special") : e.__lookupSetter__(t) && (i = h("[Setter]", "special"))), f.indexOf(t) < 0 && (n = "[" + t + "]"), i || (l.indexOf(e[t]) < 0 ? (i = null === c ? p(e[t]) : p(e[t], c - 1), i.indexOf("\n") > -1 && (i = o(e) ? i.split("\n").map(function(e) {
                            ...
                            n = JSON.stringify("" + t),
                            n.match(/^"([a-zA-Z_][a-zA-Z_0-9]*)"$/) ? (n = n.substr(1, n.length - 2), n = h(n, "name")) : (n = n.replace(/'/g, "\\'").replace(/\\"/g, '"').replace(/(^"|"$)/g, "'"), n = h(n, "string"))
                        }
                        return n + ": " + i
                    });
                    l.pop();
        ...
        3 : [function(e, t) {
            function n(e) {
                ...
                function(e, n, o) {
                    var i;
                    i = t.config.logger === r ? console: t.logger,
                    i.log("event:", e, n, o)
                })
            }
            var o = e("util"),
        ...
        11 : [function(e, t) {
            function n(e) {
                ...
                this.channels = {},
                this.pc = new r(this.parent.config.peerConnectionConfig, this.parent.config.peerConnectionConstraints),
                ...
                "screen" === e.type ? this.parent.localScreen && this.sharemyscreen && (this.logger.log("adding local screen stream to peer connection"), this.pc.addStream(this.parent.localScreen), this.broadcaster = e.broadcaster) : this.parent.localStreams.forEach(function(e) {
                    t.pc.addStream(e)
                }),
                s.call(this),
                this.on("*",
            ...
            n.prototype.handleMessage = function(e) {
                ...
                "offer" === e.type ? this.pc.handleOffer(e.payload,
                function(e) {
                    e || t.pc.answer(t.receiveMedia,
                    function(e, n) {
                        t.send("answer", n)
                    })
            ...
            n.prototype.start = function() {
                ...
                this.pc.offer(this.receiveMedia,
                function(t, n) {
                    e.send("offer", n)
                })
            },
        ...
        12 : [function(e, t) {
            function n(e) {
                ...
                this.localStreams = [],
                this.localScreens = [],
                r.support || this._logerror("Your browser does not support local media capture.")
            }
            var o = e("util"),
            i = e("hark"),
            r = e("webrtcsupport"),
            ...
            n.prototype.startScreenShare = function(e) {
                ...
                a(function(n, o) {
                    return n || (t.localScreens.push(o), o.onended = function() {
                        ...
                        t.emit("localScreenStopped", o)
                    },
                    t.emit("localScreen", o)),
                    e ? e(n, o) : void 0
                })
            },
            ...
            n.prototype.setupAudioMonitor = function(e, t) {
                ...
                function() {
                    r.emit("speaking"),
                    r.hardMuted || r.setMicIfEnabled(1)
                }),
                o.on("stopped_speaking",
                function() {
                    n && clearTimeout(n),
                    n = setTimeout(function() {
                        r.emit("stoppedSpeaking"),
                        r.hardMuted || r.setMicIfEnabled(.5)
                    },
                    1e3)
                }),
                o.on("volume_change",
            ...
            n.prototype.startLocalMedia = n.prototype.start,
            n.prototype.stopLocalMedia = n.prototype.stop,
            Object.defineProperty(n.prototype, "localStream", {
                get: function() {
            ...
            function() {
                ...
                var E = x.each = x.forEach = function(e, t, n) {
                    ...
                    if (f && e.forEach === f) e.forEach(t, n);
                        ...
                        for (var o = 0,
                        r = e.length; r > o; o++) if (t.call(n, e[o], o, e) === i) return
                    } else for (var s = x.keys(e), o = 0, r = s.length; r > o; o++) if (t.call(n, e[s[o]], s[o], e) === i) return;
                    return e
                };
                x.map = x.collect = function(e, t, n) {
                    var o = [];
                    return null == e ? o: d && e.map === d ? e.map(t, n) : (E(e,
                    function(e, i, r) {
                ...
                x.reduce = x.foldl = x.inject = function(e, t, n, o) {
                    ...
                    if (null == e && (e = []), m && e.reduce === m) return o && (t = x.bind(t, o)),
                ...
                x.reduceRight = x.foldr = function(e, t, n, o) {
                    var i = arguments.length > 2;
                    if (null == e && (e = []), y && e.reduceRight === y) return o && (t = x.bind(t, o)),
                ...
                x.filter = x.select = function(e, t, n) {
                    var o = [];
                    return null == e ? o: g && e.filter === g ? e.filter(t, n) : (E(e,
                    function(e, i, r) {
                ...
                x.every = x.all = function(e, t, n) {
                    t || (t = x.identity);
                    var o = !0;
                    return null == e ? o: v && e.every === v ? e.every(t, n) : (E(e,
                    function(e, r, s) {
                ...
                var O = x.some = x.any = function(e, t, n) {
                    t || (t = x.identity);
                    var o = !1;
                    return null == e ? o: b && e.some === b ? e.some(t, n) : (E(e,
                    function(e, r, s) {
                        return o || (o = t.call(n, e, r, s)) ? i: void 0
                    }), !!o)
                };
                x.contains = x.include = function(e, t) {
                    return null == e ? !1 : w && e.indexOf === w ? -1 != e.indexOf(t) : O(e,
                    function(e) {
                        return e === t
                    })
                },
                ...
                var D = function(e, t, n) {
                    return t && x.every(e, x.isArray) ? p.apply(n, e) : (E(e,
                    function(e) {
                ...
                x.uniq = x.unique = function(e, t, n, o) {
                    ...
                    s = [];
                    return E(i,
                    function(n, o) { (t ? o && s[s.length - 1] === n: x.contains(s, n)) || (s.push(n), r.push(e[o]))
                    }),
                    r
                },
                x.union = function() {
                ...
                x.object = function(e, t) {
                    ...
                    for (var n = {},
                    o = 0,
                    i = e.length; i > o; o++) t ? n[e[o]] = t[o] : n[e[o][0]] = e[o][1];
                    return n
                },
                ...
                x.partial = function(e) {
                    ...
                    return function() {
                        for (var n = 0,
                        o = t.slice(), i = 0, r = o.length; r > i; i++) o[i] === x && (o[i] = arguments[n++]);
                ...
                E(["Arguments", "Function", "String", "Number", "Date", "RegExp"],
                function(e) {
                    x["is" + e] = function(t) {
                ...
                x.template = function(e, t, n) {
                    ...
                    e.replace(i,
                    function(t, n, o, i, a) {
                        return s += e.slice(r, a).replace(q,
                        function(e) {
                            return "\\" + W[e]
                        }),
                        n && (s += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'"),
        ...
        14 : [function(e, t) {
            ...
            i.inherits(n, a),
            Object.defineProperty(n.prototype, "signalingState", {
                get: function() {
            ...
            n.prototype.processIce = function(e, t) {
                ...
                -1 !== e.candidate.candidate.indexOf("typ srflx") ? n.hadRemoteStunCandidate = !0 : -1 !== e.candidate.candidate.indexOf("typ relay") && (n.hadRemoteRelayCandidate = !0);
                t()
            },
            n.prototype.offer = function(e, t) {
                ...
                this.pc.createOffer(function(e) {
                    ...
                    function() {
                        ...
                        n.config.useJingle && (i = s.toSessionJSON(e.sdp, n.config.isInitiator ? "initiator": "responder"), i.sid = n.config.sid, n.localDescription = i, o.each(i.contents,
                        function(e) {
                            var t = e.transport || {};
            ...
            n.prototype.handleOffer = function(e, t) {
                ...
                n.pc.setRemoteDescription(new r.SessionDescription(e),
                function() {
                    t()
                },
                t)
            ...
            n.prototype._onIce = function(e) {
                ...
                if (e.candidate) {
                    ...
                    } - 1 !== n.candidate.indexOf("typ srflx") ? this.hadLocalStunCandidate = !0 : -1 !== n.candidate.indexOf("typ relay") && (this.hadLocalRelayCandidate = !0),
                    this.emit("ice", i)
        ...
        17 : [function(e, t) {
            ...
            t.exports = function(e, t) {
                ...
                s = r ? t: e;
                if ("undefined" == typeof window || "http:" === window.location.protocol) return i = new Error("NavigatorUserMediaError"),
                i.name = "HTTPS_REQUIRED",
                s(i);
                if (window.navigator.userAgent.match("Chrome")) {
                    ...
                    n(e, s);
                        ...
                        var u = window.setTimeout(function() {
                            return i = new Error("NavigatorUserMediaError"),
                            i.name = "EXTENSION_UNAVAILABLE",
                            s(i)
                        },
                        1e3);
                        o[u] = [s, r ? constraint: null],
                        window.postMessage({
                            type: "getScreen",
                            id: u
                        },
        ...
        23 : [function(e, t, n) {
            ...
            n.toMediaSDP = function(e) {
                ...
                "rtp" == i.descType && t.push("a=rtcp:1 IN IP4 0.0.0.0"),
                ...
                "rtp" == i.descType && t.push("a=" + (o[e.senders] || "sendrecv")),
                t.push("a=mid:" + e.name),
        ...
        16 : [function(e, t) {
            ...
            t.exports = function(e, t) {
                ...
                d = new Float32Array(m.fftSize),
                e.jquery && (e = e[0]),
                e instanceof HTMLAudioElement || e instanceof HTMLVideoElement ? (f = r.createMediaElementSource(e), "undefined" == typeof p && (p = !0), u = u || -50) : (f = r.createMediaStreamSource(e), u = u || -50),
                f.connect(m),
                ...
                var g = function() {
                    setTimeout(function() {
                        if (h) {
                            ...
                            s.speakingHistory.shift(),
                            s.speakingHistory.push(0 + (e > u)),
                            g()
                        }
                    },
                    c)
        ...
        24 : [function(e, t, n) {
            ...
            n.findLine = function(e, t, n) {
                for (var o = e.length,
                i = 0; i < t.length; i++) if (t[i].substr(0, o) === e) return t[i];
                if (!n) return ! 1;
            ...
            n.fmtp = function(e) {
                for (var t, n, o, i = e.substr(e.indexOf(" ") + 1).split(";"), r = [], s = 0; s < i.length; s++) t = i[s].split("="),
                n = t[0].trim(),
                o = t[1],
                n && o ? r.push({
                    key: n,
            ...
            n.groups = function(e) {
                for (var t, n = [], o = 0; o < e.length; o++) t = e[o].substr(8).split(" "),
                n.push({
                    semantics: t.shift(),
                    contents: t
                });
        ...
        21 : [function(e, t) {
            ...
            s = e("wildemitter");
            i.inherits(o, s),
            Object.defineProperty(o.prototype, "signalingState", {
                get: function() {
